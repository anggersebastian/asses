                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputPassword1" name="tanggal_lahir" placeholder="tanggal lahir">
                                </div>
                                <div class="form-group">
                                    <label>Gaji</label>
                                    <input type="number" class="form-control" id="exampleInputPassword1" name="gaji" placeholder="gaji">
                                </div>
                                <div class="form-group">
